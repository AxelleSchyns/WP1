...
do
  ...
  --extractor "resnet","deit","dino_vit","dino_vit","dino_vit","byol_light","byol_light","byol_light","ibot_vits","ibot_vits","ibot_vits","ret_ccl","cdpath","phikon","ctranspath","uni","hoptim" \
  --num_features 128,128,384,384,384,256,256,256,384,384,384,2048,512,768,768,1024,1536 \
