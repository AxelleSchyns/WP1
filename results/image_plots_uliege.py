...
if __name__ == "__main__":
    ...
    extractor_name_med = ['retccl', 'uni',  'uni2', 'ctranspath', 'cdpath', 'Phikon v2', 'phikon', 'hoptimus v1', 'hoptimus',  'Virchow v2']
    search_strings_med=['ret_ccl', 'uni', 'ctranspath', 'cdpath','phikon', 'hoptim', 'virchow2']
    # Labels for ssl meds - in order of folders
    label0_med=['False', 'False', 'False', 'False', 'False', 'False', 'False', 'False', 'False', 'False']
    label1_med=['True',  'True',  'False', 'True',  'Wrong', 'False', 'True',  'False', 'False', 'False']
    label2_med=['True',  'True',  'True',  'True',  'True',  'True',  'True',  'True',  'True',  'True']
    label3_med=['True',  'True',  'True',  'True',  'False', 'True',  'False', 'True',  'True',  'True']
    label4_med=['True',  'True',  'False', 'True',  'True',  'True',  'True',  'True',  'True',  'True']
    label5_med=['True',  'False', 'False', 'False', 'False', 'False', 'False', 'True',  'True',  'False']
        ...
        for j in range(6):
            ...
            for i in range(1, len(inputs)+1):
                ...
                if label_med[i-1]=='Wrong':
                    ...
                    rect = patches.Rectangle((0, 0),  width, height-30,  linewidth=3, edgecolor='red', facecolor='none' )
