...
if __name__ == "__main__":
    ...
    label0_med=['True','True','True','True','True','True']
    label1_med=['False','False','False','False','True','False']
    label2_med=['False','False','True','False','False','False']
    label3_med=['True','True','True','True','True','True']
    label4_med=['True','True','True','True','True','True']
    label5_med=['True','True','True','True','True','True']
