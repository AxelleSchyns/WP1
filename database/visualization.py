...
def plot_im_curve(path, path_queries):
    ...
    model_11_props = [0.76778465, 0.76523952, 0.76405804, 0.76308736, 0.76263819, 
                      0.76177836, 0.76097088, 0.76066064, 0.76003303, 0.75963192] # ibot fine

    model_12_props = [0.75903025, 0.75691712, 0.75586576, 0.75480139, 0.75377345,
                        0.75293028, 0.75217484, 0.75147815, 0.75074081, 0.75015406] # ibot scratch

    model_13_props = [0.76420378, 0.76188766, 0.76009202, 0.75831720, 0.75717944,
                        0.75589178, 0.75491552, 0.75409614, 0.75331196, 0.75254513] # ctrans

    model_14_props = [ 0.78047384, 0.77723128, 0.77580344, 0.77432182, 0.77318927, 0.77228329, 0.77130901, 0.77078129, 0.77017537, 0.76955426] # phikon

    model_15_props = [ 0.58391106, 0.58067370, 0.57777292, 0.57559386, 0.57398663, 0.57233395, 0.57088728, 0.56943403, 0.56823550, 0.56716112] # cdpath 
   
    model_16_props = [ 0.79346491, 0.79146108, 0.79071333, 0.78950149, 0.78865363, 
                      0.7879843, 0.78728166, 0.78669743, 0.78607647, 0.7854829] # uni 
    
    model_17_props = [0.75852018, 0.75883247, 0.76045635, 0.75952991, 0.75847855, 
                      0.75757292, 0.75708367, 0.75379427, 0.75473112, 0.75465826] #hoptim 
    
    model_18_props = [0.79609852, 0.79045656, 0.78793746, 0.78655299, 0.78519976, 
                  0.78319072, 0.7818479, 0.78238919, 0.78185831, 0.77943289] #uni 

    model_19_props = [0.77653905, 0.77363479, 0.76923157, 0.76888806, 0.76669165, 
                  0.76457852, 0.76275685, 0.76219474, 0.76325651, 0.76043553] # virchow2
